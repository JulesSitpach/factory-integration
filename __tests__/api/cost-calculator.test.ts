...
describe('Cost Calculator API', () => {
  ...
  describe('POST handler', () => {
    ...
    it('should return 400 error when materials cost is missing', async () => {
      ...
      // Assert
      expect(response.body).toHaveProperty('error', 'Materials cost must be a valid non-negative number');
    ...
    it('should return 400 error when labor cost is missing', async () => {
      ...
      // Assert
      expect(response.body).toHaveProperty('error', 'Labor cost must be a valid non-negative number');
      expect(response.options).toHaveProperty('status', 400);
    });
    ...
    it('should return 400 error when overhead cost is missing', async () => {
      ...
      // Assert
      expect(response.body).toHaveProperty('error', 'Overhead cost must be a valid non-negative number');
      expect(response.options).toHaveProperty('status', 400);
    });
